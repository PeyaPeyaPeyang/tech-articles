...
## Chapter 3. Java Virtual Machine のためのコンパイル手法

その名前からイメージできるように，Java 仮想マシン（JVM） は Java 言語のために設計された仮想マシンです。
...
あるコンパイラが JVM をどのように利用するかを学ぶことは，これからコンパイラを自作しようとする人にも，或いは JVM を理解しようとする人にも非常に役立ちます。
