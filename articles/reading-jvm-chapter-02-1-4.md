...
映画・マトリックスの登場人物のように，その中の命令を私は直接読めませんし，たぶん皆様も一緒であると思います。
そこで，私は バイト・コードを ASCII 文字列で表す `javap` のような記法で表しますから，どうぞご安心してお読みください。
...
このセクションでは，JVM の**型システム**について説明します。
